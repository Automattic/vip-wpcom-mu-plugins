...
phpcs:
	...
	/tmp/phpcs/scripts/phpcs -p . --standard=WordPress-VIP --extensions=php --ignore=Rewrite-Rules-Inspector/*,amp-wp/*,batcache/*,http-concat/*,jetpack/*,media-explorer/*,writing-helper/*
