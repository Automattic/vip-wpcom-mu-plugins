...
phpcs:
	...
	/tmp/phpcs/scripts/phpcs -p . --standard=WordPress-VIP --extensions=php --runtime-set ignore_warnings_on_exit true --ignore=Rewrite-Rules-Inspector/*,amp-wp/*,batcache/*,http-concat/*,jetpack/*,media-explorer/*,writing-helper/*
